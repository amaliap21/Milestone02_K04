  ...
  return (
    <div>
      ...
      <div id="overviewArticle" style={{ paddingTop: "100px" }}>
        <div id="container-art1">
          <div id="fixedwidth">
            <div id="header32">
              <h1 id="desctitle" style={{ fontSize: "25px" }}>
          ...
          <div className="fixedwidth">
            <div id="headernj">
              <p id="descnj" style={{ fontSize: "17px" }}>
                Sebagian kalangan menuding, kemasan botol dan galon plastik
                polyethylene terephthalate (PET) sekali pakai, sebagai sampah
                tak berguna. Padahal, sampah plastik jenis PET adalah bahan baku
                ...
                delapan juta ton pada 2025.
                <br></br>
                <br></br>
                "Tingkat daur ulang (recycle rate) sampah plastik di Indonesia
                baru menyentuh angka tujuh persen, dengan jenis plastik jenis
                PET (yang lazim digunakan untuk kemasan AMDK botol dan galon)
                mencapai 75 persen tingkat daur ulang," tulis paparan laporan
                lembaga Sustainable Waste Indonesia (SWI) belum lama ini.
                <br></br>
                <br></br>
                ...
                sirkular dan mencapai target zero waste pada 2050. Sepanjang
                2022, KLHK menorehkan catatan sebanyak 64 persen timbulan sampah
                yang telah berhasil dikelola dari total 68,5 juta ton sampah
                nasional.
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                Data itu mirip dengan laporan pasca perayaan malam Tahun Baru
                2023 di Jakarta yang mencatat sampah terbanyak adalah botol air
                ...
                menargetkan pengurangan sampah hingga sebesar 30 persen pada
                2030. Target pengurangan tersebut dilakukan dengan, antara lain
                ...
                menekan volume sampah di Indonesia," kata Rosa. Menurut dia,
                KLHK terus mendorong para pelaku usaha agar mempermudah
                pengelolaan sampah plastik dengan memperbesar ukuran produk,
